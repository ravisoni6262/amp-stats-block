...
class PluginTest extends BlockExtendTestCase {
	 ...
	 *
	 * @covers AMPS\BlockExtend\Plugin::__construct()
	 * @covers AMPS\BlockExtend\Plugin::file()
	 * @covers AMPS\BlockExtend\Plugin::dir()
	 */
	 ...
	 * Test the plugin setup.
	 *
	 * @covers AMPS\BlockExtend\Plugin::basename()
	 */
